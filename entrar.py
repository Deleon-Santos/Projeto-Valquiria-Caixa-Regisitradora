...
col2=[
    ...
    sg.Input('2024-03-21 17:41:22',key="-DATA-",font=('any',19),size=(20,1))],   
]

layout=[
    [sg.Push(),sg.T('ENTRAR EM VENDAS',font=('Any',30,'bold')),sg.P()],
    [sg.Col(col1),sg.VerticalSeparator(),sg.Col(col2)],
    [sg.P(),sg.B("OK",font=('any',10,'bold'),size=(10,2)),sg.P()],
    [sg.HorizontalSeparator()],
    [sg.P(),sg.B('SAIR',font=('any',10,'bold'),size=(10,1),button_color='red'),sg.P(),sg.B('SUPORTE',font=('any',10,'bold'),size=(10,1)),sg.P()]
]

window = sg.Window("NOVO PEDIDO", layout,size=(800,450),finalize=True,icon="imagem/favicon")
while True:
