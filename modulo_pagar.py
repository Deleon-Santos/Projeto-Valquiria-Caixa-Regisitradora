...
def pagar(valor_pagar):
    ...
    frame6=[[sg.P(),sg.T("Valor da Compra ", size=(23, 1), font=("Any", 12)),
            ...
            [sg.T("", size=(10, 1))],
            [sg.P(),sg.B("CARTAO", font=("Any", 12),size=(15, 1)), sg.B('PIX',font=("Any", 12), size=(15, 1)), 
             sg.B('DINHEIRO',font=("Any", 12), size=(15, 1)),sg.P(),sg.B("CONCLUIR",font=("Any", 12), size=(15, 1)),sg.P()],]
